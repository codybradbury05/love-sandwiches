...
def validate_data(values):
    """
    Converts all string values into integers. Raises ValueError if
    strings cannot be converted into int, or if there isnt 6 values.
    """
    try:
...
def update_worksheet(data, worksheet):
    """
    Recieve a list of integers to be insert into a worksheet
